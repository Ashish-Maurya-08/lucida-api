...
export type GetByUrlResponse = TrackGetByUrlResponse | ArtistGetByUrlResponse | AlbumGetByUrlResponse | EpisodeGetByUrlResponse | PodcastGetByUrlResponse | PlaylistGetByUrlResponse;
...
export interface Streamer {
    ...
    getByUrl: ((url: string) => Promise<GetByUrlResponse>) | ((url: string, limit?: number) => Promise<GetByUrlResponse>);
